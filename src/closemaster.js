...
const CloseMaster = () => {
  ...
  function getSheetData(e) {
    ...
    if (value != "" && checked == true) {
      ...
      setDptempdata(JSON.parse(newobj[0].dp));
      setDpdata(JSON.parse(newobj[0].dp));
      setTptempdata(JSON.parse(newobj[0].tp));
      setTpdata(JSON.parse(newobj[0].tp));
      setSpptempdata(JSON.parse(newobj[0].single));
      setSppdata(JSON.parse(newobj[0].single));
    }
